...
//This query inserts a record in the user table
        ...
        //check for a phone number
				...
				{
					$c = mysqli_real_escape_string($connect, trim ($_POST['City']));
				}
				...
				{
					$s = mysqli_real_escape_string($connect, trim ($_POST['State']));
				}
				...
				{
					$pc = mysqli_real_escape_string($connect, trim ($_POST['PostalCode']));
				}
				...
				{
					$nc = mysqli_real_escape_string($connect, trim ($_POST['NameCard']));
				}
				...
				{
					$b = mysqli_real_escape_string($connect, trim ($_POST['Bank']));
				}
...
<form action="index.php?page=placeorder" method="post">
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="inputBox">
                <span>Full Name :</span>
                <input type="text" id="FullName" name="FullName" placeholder="ahmad">
            </div>
            <div class="inputBox">
                <span>Email :</span>
            ...
            <div class="inputBox">
                <span>Address :</span>
                <input type="text" id="Address" name="Address" placeholder="number - street - area">
            </div>
            <div class="inputBox">
                <span>City :</span>
            ...
            <div class="flex">
                <div class="inputBox">
                    <span>State :</span>
                    <input type="text" id="State" name="State" placeholder="Wilayah Persekutuan">
                </div>
                <div class="inputBox">
                    <span>Postal Code :</span>
                    <input type="text" id="PostalCode" name="PostalCode" placeholder="55100">
                </div>
            </div>
        ...
        <div class="col">
            ...
            <div class="inputBox">
                ...
                <input type="text" id="NameCard" name="NameCard" placeholder="AHMAD BIN MAD">
            </div>
            <div class="inputBox">
                        <span>Bank :</span>
